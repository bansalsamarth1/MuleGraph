...
echo "=== MuleGraph Phase 2C Verification: Fan-In Rule ==="
...
echo "3. Sending 5 transactions from FIVE distinct sources to ONE destination..."
...
EOF
  ...
  echo "Sending transaction $i from source $SRC_ID"
